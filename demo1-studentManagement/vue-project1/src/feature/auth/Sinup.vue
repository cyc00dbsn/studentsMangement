<template>
  <Form class="mx-auto w-1/3 mt-30 shadow-2xl shadow-blue-300 rounded-box" @submit="onSubmit" :validation-schema="validationSchema">
    ...
    <div class="text-center">
      <button class="btn btn-primary mx-2 my-2">Sinup</button>
      <button class="btn btn-secondary m2-2 my-2" @click="router.push({name:'login'})" >Login</button>
    </div>
  </Form>
</template>
...
async function onSubmit(){
  const data = await getSignup(email.value,password.value);
